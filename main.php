  ...
  <div class="container">
    ...
    <section id="topico2" class="sugestoes">
      <div class="img-container">
        <img src="maldives-tropical-beach-resort-wallpaper.jpg" class="bg-img">
        </img>
      </div>
      ...
      <div class="card-wrapper">
        <div class="card">
          <div class="front-side">
            <img src="maldives-tropical-beach-resort-wallpaper.jpg" alt="#" class="card-image">
          ...
          <div class="back-side center">
            ...
            <h3 class="package-price">
              <?php
                ...
                $query = "SELECT Hoteis.Pais, Destinos.pais_id FROM Hoteis INNER JOIN Destinos WHERE Destinos.pais_id=Hoteis.Pais";
                $result = $conn->query($query);
                $test_print = $result->fetch_assoc();
                echo $test_print['Pais']
              ?>
            </h3>
            <button class="card-button">Reserve agora</button>
          </div>
        ...
        <div class="card">
          <div class="front-side">
            <img src="cruzeiro_3.jpg" alt="#" class="card-image">
        ...
        <div class="card">
          <div class="front-side">
            <img src="Cruzeiro.jpg" alt="#" class="card-image">
